...
public class Scenario_Manager : MonoBehaviour
{
    ...
    public void MoveScene(string sceneName, System.Single nextSpownPoint)
    {
    ...
    public void InitTime()
    {
        ...
        InitPos initPos = GameObject.Find("XR Rig").GetComponent<InitPos>();
        initPos.sponePoint = 1;
        player_Status.set_hp_init();
        player_Status.player_Mp = player_Status.player_Max_Mp;
        SceneManager.LoadScene("School_morning");
    }
    public void InitTimeAtOutSide_nonScene()
    {
        ...
        player_Status.set_hp_init();
        player_Status.player_Mp = player_Status.player_Max_Mp;
        SceneManager.LoadScene("Field_morning");
    }
    ...
    public void check_towerLevel (System.Single level)
    {
    ...
    public void FollowNpc(string targetModelName)
    {
        ...
        //Luna, Npc bool값과 Npc이름만 정확하게 설정하면 원할하게 작동.
    ...
    //NPC 관련 로직 - 현재 어떤 NPC가 같이 하고 있는지 모르는 상황에 사용
    public void MainNpcFollowInit()
    {
        ...
        {
            Debug.Log("메인캐릭터가 존재 하지 않습니다. 매니저만 정보를 변경합니다.");
        }
        npcManagement.Luna = false;
    }
    public void SubNpcFollowInit()
    {
        ...
        {
            Debug.Log("서브캐릭터가 존재 하지 않습니다. 매니저만 정보를 변경합니다.");
        }
    ...
    {
        //Follow Stop Coroutine - 설정해 놓은 목적지 잃기 않기 위함
