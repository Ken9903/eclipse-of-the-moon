...
public class Mag_Info_BasicShot : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bullet_count = 9 + skillManager.useAble[Resources.Load<GameObject>("BasicShot")];
    ...
    {
        if (collider.name == "mag_hole" && !gunShot_Trigger.magEquiped && !equiped)
        {
            equiped = true;
